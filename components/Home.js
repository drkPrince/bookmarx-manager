      ...
      <div className="flex flex-col sm:flex-row sm:max-h-screen items-center">
        <div className="py-20 sm:py-32 px-6 sm:pl-20 w-full sm:w-1/2">
          ...
          <p className="text-gray-700 text-xl mt-3 mb-6 leading-relaxed">
            With Bookmarx, you can save your favorite links on the internet and
            organise them in searchable collections. This helps you to come back
            to it later.
          </p>
          ...
          <p className="text-sm mt-6 text-gray-600">
            *You can log in using demo credentials. Username: Tony and Password:
            Stark
          </p>
        </div>
